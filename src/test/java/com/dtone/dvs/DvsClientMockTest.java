...
public class DvsClientMockTest {
	...
	public void testOperatorAPIs() throws Exception {
		...
		when(dvsClientHelper.getOperators(Mockito.anyString(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getOperators());
		...
		when(dvsClientHelper.lookupOperators(Mockito.anyString(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getOperators());
	...
	public void testBenefitTypeAPIs() throws Exception {
		...
		when(dvsClientHelper.getBenefitTypes(Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getBenefitTypes());
	...
	public void testPromotionAPIs() throws Exception {
		...
		when(dvsClientHelper.getPromotions(Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getPromotions());
		...
		when(dvsClientHelper.getPromotions(Mockito.any(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getPromotions());
		ApiResponse<List<Promotion>> apiResponsePromotionsFiltersAll = dvsClient.getPromotions(new PromotionFilter("BGD", 1L, 1L));
		assertNotNull(apiResponsePromotionsFiltersAll.getResult());
		
		when(dvsClientHelper.getPromotions(Mockito.any(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getPromotions());
		ApiResponse<List<Promotion>> apiResponsePromotionsFilters = dvsClient.getPromotions(new PromotionFilter("BGD", 1L, 1L), 1, 100);
	...
	public void testProductAPIs() throws Exception {
		...
		when(dvsClientHelper.getProducts(Mockito.any(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getProducts());
	...
	public void testTransactionAPIs() throws Exception {
		when(dvsClientHelper.getTransactions(Mockito.any(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getTransactions());
		ApiResponse<List<TransactionResponse>> apiResponseTransactionsFiltersAll = dvsClient.getTransactions(new TransactionFilter("NEX-123"));
		assertNotNull(apiResponseTransactionsFiltersAll.getResult());
		
		when(dvsClientHelper.getTransactions(Mockito.any(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(MockTestUtils.getTransactions());
		ApiResponse<List<TransactionResponse>> apiResponseTransactions = dvsClient.getTransactions(new TransactionFilter("NEX-123"), 1, 100);
		...
		when(dvsClientHelper.postTransaction(Mockito.any(), Mockito.anyBoolean())).thenReturn(MockTestUtils.getTransaction());
		ApiResponse<TransactionResponse> apiResponseTransactionPost = dvsClient.createTransaction(new TransactionRequest(), true);
		assertNotNull(apiResponseTransactionPost.getResult());
		
		when(dvsClientHelper.confirmTransaction(Mockito.anyLong(), Mockito.anyBoolean())).thenReturn(MockTestUtils.getTransaction());
		ApiResponse<TransactionResponse> apiResponseTransactionConfirm = dvsClient.confirmTransaction(1L, true);
